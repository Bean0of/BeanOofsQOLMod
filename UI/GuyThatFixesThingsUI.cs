using BeanOofsQOLMod.NPCs.GuyThatFixesThings;
...
{
    // https://github.com/tModLoader/tModLoader/blob/dfe30aae2a3ecc8f5f7bc45db2132e386ddb90f5/ExampleMod/UI/ExamplePersonUI.cs
    ...
    internal class GuyThatFixesThingsUI : UIState
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != ModContent.NPCType<GuyThatFixesThings>())
            {
                ...
                ModContent.GetInstance<BeanOofsQOLMod>().GuyThatFixesThingsInterface.SetState(null);
            }
        }
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            if (!_vanillaItemSlot.Item.IsAir)
            {
                int awesomePrice = Item.buyPrice(0, 2, 0, 0);
            ...
            {
                string message = "Place an item with a bad reforge here to fix it";
                ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, Main.fontMouseText, message, new Vector2(slotX + 50, slotY), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, Vector2.Zero, Vector2.One*0.9f, -1f, 2f);
            }
        }
    }
}
